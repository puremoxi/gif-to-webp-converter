...
!(function (e, t) {
  ...
  (() => {
    ...
    (() => {
      ...
      if (!t && s) {
        s.currentScript && (t = s.currentScript.src);
        if (!t) {
    ...
    class i {
      ...
      on(e, t) {
        if (e === "log") this.#r.push(t);
        else if (e === "progress") this.#a.push(t);
      }

      off(e, t) {
        if (e === "log") this.#r = this.#r.filter((e) => e !== t);
        else if (e === "progress") this.#a = this.#a.filter((e) => e !== t);
      }
      ...
      writeFile = (e, s, { signal: r } = {}) => {
        const a = [];
        if (s instanceof Uint8Array) a.push(s.buffer);
        return this.#i(
